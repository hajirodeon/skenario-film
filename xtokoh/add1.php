...
//cek, sudah ada belum
$SQL1 = sprintf("SELECT * FROM skenario_tokoh ".
					"WHERE nama = '$nama'");
...
if ($totalRows_rs1 != 0) 
	...
	//perintah SQL
	$SQL2 = sprintf("INSERT INTO skenario_tokoh(kd, kd_skenario, nama, panggilan, usia, fisik, psikis, ".
						"status, agama, profesi, cirikhusus, latarbelakang, peran) ".
						"VALUES ('$x', '$skenkd', '$nama', '$panggilan', '$usia', '$fisik', '$psikis', ".
						"'$status', '$agama', '$profesi', '$cirikhusus', '$latarbelakang', '$peran')");
