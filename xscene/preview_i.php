...
$query_rs1 = "SELECT m_lokasi.*, m_waktu.*, skenario_sceneplot.* ".
...
$query_rsx = "SELECT m_lokasi.*, m_waktu.*, skenario_sceneplot.* ".
				"FROM m_lokasi, m_waktu, skenario_sceneplot ".
				"WHERE skenario_sceneplot.kd_lokasi = m_lokasi.kd ".
				"AND skenario_sceneplot.kd_waktu = m_waktu.kd ".
				"AND skenario_sceneplot.kd = '$scenekd'";
...
$judul = "$jd019 $row_rs1[nomer]. $row_rs1[lokasi] $row_rs1[tempat] - $row_rs1[waktu]";
?>
<html>
<head>
...
<table width="600" border="0" cellpadding="3" cellspacing="0">
  <tr> 
    <td height="642" valign="top"> <p><font color="#000000"><font color="#000000"><?php echo xheadline($judul);?></font></font></p>
      <p> <font color="#000000"> 
        <? ///nek isih kosong
	if ($totalRows_rsx == 0)
		{
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr valign="top" bgcolor="<? echo $warna; ?>"> 
          <td> <font color="#000000"><strong><? echo balikin($row_rsx['nomer']); ?>. <? echo balikin($row_rsx['lokasi']); ?> <? echo strtoupper(balikin($row_rsx['tempat'])); ?> - 
			...
			?>
            </font>  <br> <br><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <?
		do
			{
		?>
