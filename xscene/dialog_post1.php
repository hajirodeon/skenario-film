...
//perintah SQL
$SQL2 = sprintf("INSERT INTO skenario_scene_dialog(kd, kd_skenario, kd_sceneplot, kd_deskripsi, ".
					"pemain, dialog) ".
					"VALUES ('$x', '$skenkd', '$scenekd', '$deskkd', '$pemain', '$dialog')");
